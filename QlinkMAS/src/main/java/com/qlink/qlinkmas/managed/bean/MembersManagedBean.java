...
@RequestScoped
public class MembersManagedBean {
    ...
    public String createMember(){
        ...
        memBean.createMember(firstName, lastName, initials, idNo, dob, gender, cellNo, email);
        FacesMessage msg = new FacesMessage("","New member added sucessfully");
    ...
    public String removeMember(Members m){
        ...
        FacesMessage msg = new FacesMessage("","Member deleted sucessfully");
        FacesContext.getCurrentInstance().addMessage(null, msg);
